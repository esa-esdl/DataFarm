...
CubeEvent(s::FloatingPoint) = CubeEvent(1,[s],[s],[s],[0.5],[0.5],[0.5])
...
@doc "RandomWalkEvent, generates N events. The event is generated by doing a Random Walk in 3D crossing starting at px,py,pz. with step probabilities px,py,pz in the respective directions"->
